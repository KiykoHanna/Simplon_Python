def decode_text(text:str, cle:int)->str:
    """
    Decode un texte en utilisant le code de César.
    ...
    Args:
        text (str): Le texte à decoder.
        cle (int): La clé de décalage (nombre entier de positions à décaler).

    Returns:
        str: Le texte decodé avec le décalage appliqué.
    ...
    Exemple:
        >>> decoder("DEFGHIJKLMNOPQRSTUVWXYZABC", 3)
